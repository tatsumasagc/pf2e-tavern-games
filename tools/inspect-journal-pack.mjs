...
const source = "./packs/poppys-prize-journals";
const destination = "./build/inspected-poppys-prize-journals";
...
console.log("Poppy’s Prize JournalEntry compendium pack validation passed.");
